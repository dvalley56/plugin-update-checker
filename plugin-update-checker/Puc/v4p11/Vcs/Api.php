...
if ( !class_exists('Puc_v4p11_Vcs_Api') ):
	...
	abstract class Puc_v4p11_Vcs_Api {
		...
		public function getRemoteReadme($ref = 'main') {
			// $fileContents = $this->getRemoteFile('README.md', $ref);
		...
		public function setSlug($slug) {
			// $this->slug = $slug;
			/*
				replace below with our slug, it would be your plugin file name without the extension
